				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#features" class="menu__link scroll">About</a></li>
...
<!-- banner-bottom -->
	<div class="banner-bottom" id="features">
		<div class="container">	
...
<!-- //gallery -->
	 ...
	 <!--// rooms & rates -->
    <div class="copy">
		        <p>© 2020 web lab mini project. All Rights Reserved</p>
	</div>
</body>
</html>
